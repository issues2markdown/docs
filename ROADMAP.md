...
- [ ] issues2markdown/cli : [Support for --templateFile to customize the output](https://github.com/issues2markdown/cli/issues/50)
- [ ] issues2markdown/cli : [Support for --format to customize the output by hand](https://github.com/issues2markdown/cli/issues/49)
- [ ] issues2markdown/cli : [Support ordering direction](https://github.com/issues2markdown/cli/issues/48)
- [ ] issues2markdown/cli : [Support ordering](https://github.com/issues2markdown/cli/issues/47)
